...
1. use the search functionality [here](bla)to see if someone already filed the same issue;
...
1. Install dependencies with our instructions;
1. make sure the existing tests still work by running the tests;
